...
const headerEl = `
	<div class="header">
				...
				<div class="nav">
					<span class="navbutton hvr-underline-from-center"><i class="fa-solid fa-house fa-sm"></i><a href="/index.html">Home</a></span> 
					<span class="navbutton hvr-underline-from-center"><i class="fa-solid fa-film fa-sm"></i><a href="/gallery.html">Work</a></span> 
					<span class="navbutton hvr-underline-from-center"><i class="fa-solid fa-user fa-sm"></i><a href="/about.html">About</a> </span>
					<span class="navbutton hvr-underline-from-center"><i class="fa-solid fa-envelope fa-sm"></i><a href="/contact.html">Contact</a> </span>
				</div>
			</div>
`;
...
const footerEl = `
	<div class="footer">
				<p><i class="fa-regular fa-copyright"></i> Copyright 2025 Molly Hartman || <a href="/credits.html"> Website Credits</a> || <a href="#top"> To Top</a> || Hosted with <a href="https://www.neocities.org">Neocities</a></p>
			</div>
`;
